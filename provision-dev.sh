...
function provision_vpc {
  ...
  TEMPLATE_URL="https://template-bucket-templatebucket-civakigopbg2.s3.eu-west-2.amazonaws.com/vpc/template.yaml?versionId=MjItVB6rTL748aqeNR6T9NzzQznxPveQ" ./provisioner.sh "${AWS_ACCOUNT}" vpc vpc "${VPC_TEMPLATE_VERSION}"
}
