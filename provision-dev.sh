...
function provision_vpc {
  ...
  TEMPLATE_URL="https://template-bucket-templatebucket-civakigopbg2.s3.amazonaws.com/vpc/template.yaml?versionId=l6YNF_tSFnmMdfl2cLiT5ngTT.BEWCEw" ./provisioner.sh "${AWS_ACCOUNT}" vpc vpc LATEST
}
